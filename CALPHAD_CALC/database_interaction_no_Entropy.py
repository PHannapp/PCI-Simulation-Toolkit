...
def S_LANI5H7(T):
   return 1/10*1000*(5.62825442803992e-06 * T**2 + -0.006678618935576874 * T + 2.4175973314739525)
def S_LANI5(T):
...
def GLA_NI_H_H(T):
   return 1*GHSERLA(T) + 5*GHSERNI(T) + 3.5*GHSERH2(T) + (-294242) + (455.0 * T) + 13*S_LANI5H7(T)
def GLA_NI_H_V(T):
   return 1*GHSERLA(T) + 5*GHSERNI(T) + 0.5*GHSERH2(T) + (-169786) + (65.0 * T) + 7*(1/7*S_LANI5H7(T) + 6/7*S_LANI5(T))
def GLA_NI_V_H(T):
   return 1*GHSERLA(T) + 5*GHSERNI(T) + 3.0*GHSERH2(T) + (-260587) + (390.0 * T) + 12*(6/7*S_LANI5H7(T) + 1/7*S_LANI5(T))
def GLA_NI_V_V(T):
   return 1*GHSERLA(T) + 5*GHSERNI(T) + 0*GHSERH2(T) + (-165689) + (0 * T) + 6*S_LANI5(T)

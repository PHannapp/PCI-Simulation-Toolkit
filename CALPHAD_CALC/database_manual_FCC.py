...
# Endmembers -------------------------------------------------------------------------------
def GVV_V(T):
   return 16*GHSERV(T) + 0*GHSERH2(T) + (107548) + (0 * T)
def GVV_H(T):
   return 16*GHSERV(T) + 31 / 2 *GHSERH2(T) + (-942918) + (31 / 2 * 130 * T)

# Interaction parameters -------------------------------------------------------------------
def LVV_HV_0(T):
    return -292731.11620983
def LVV_HV_1(T):
    return 1156432.50644241  
def LVV_HV_2(T):
    return -67000.75389615 

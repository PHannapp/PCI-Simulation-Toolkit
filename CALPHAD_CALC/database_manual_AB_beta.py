...
# Endmembers -------------------------------------------------------------------------------
def GFE_TI_V(T):
   return 8*GHSERTI(T) + 8*GHSERFE(T) + 0*GHSERH2(T) + (-971100.5127977859) + (0* T)
def GFE_TI_H(T):
   return 8*GHSERTI(T) + 8*GHSERFE(T) + 31/2*GHSERH2(T) + (-1051014.283999409) + (31 / 2 * 130 * T)

# Interaction parameters -------------------------------------------------------------------
def LFE_TI_HV_0(T):
    return -630616.96457739 
def LFE_TI_HV_1(T):
    return  -374555.60717493  
def LFE_TI_HV_2(T):
    return 820757.00131671 

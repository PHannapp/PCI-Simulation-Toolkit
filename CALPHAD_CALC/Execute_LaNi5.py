...
#plt.rcParams['lines.linewidth'] = 3  # Makes all plot lines thicker
#plt.rcParams['font.size'] = 18       # Increases font size for all text
#plt.rcParams['axes.linewidth'] = 2   # Makes the axes borders thicker
#plt.rcParams['xtick.major.width'] = 2  # Increases tick width for major ticks
#plt.rcParams['ytick.major.width'] = 2
#plt.rcParams['grid.linewidth'] = 2    # Makes grid lines thicker
...
plot_descriptor = "LaNi5_comb_323_no_exp"
...
for num in range(len(file_names)):
    ...
    T = 323  # Set temperature (in Kelvin)
    t0 = time.time()
    for i in range(1):
        structure_list = []

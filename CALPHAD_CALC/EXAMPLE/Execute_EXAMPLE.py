...
dir = r"/yourdirectory/"
dir = r"/home/pet69516/Dokumente/DFTforCALPHAD/CALPHAD_CALC/EXAMPLE/"
...
for num in range(len(file_names_1)):
    file_name_1 = file_names_1[num]
    file_name_2 = file_names_2[num]

    database_modules = [file_name_1, file_name_2] 
    name = [names_1[num], names_2[num]]
    solids =[[["NB", "ZR"]], [["NB", "ZR"]]]  # Define solids involved in the structure
    multiplicities = [multiplicitiess_1[num], multiplicitiess_2[num]]  # Define the multiplicity of sites in the structure
    x_NB = 0.25
    site_fractions = [[[x_NB, 1-x_NB]], [[x_NB, 1-x_NB]]]  # Initial site fractions for hydrogen
    color = ["blue"]
    FORCE = True
    MIN_Y = -10
    MAX_Y = 10
    ...
    T = 700+273.15  # Set temperature (in Kelvin)
    t0 = time.time()
    for i in range(1):
        structure_list = []

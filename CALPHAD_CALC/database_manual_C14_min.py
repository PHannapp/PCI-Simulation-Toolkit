...
# Endmembers -------------------------------------------------------------------------------
def GTI_MN_V(T):
   return 8*GHSERTI(T) + 16*GHSERMN(T) + 0*GHSERH2(T) + (-559868.82349495) + (0* T)
def GTI_MN_H(T):
   return 8*GHSERTI(T) + 16*GHSERMN(T) + 31/2*GHSERH2(T) + (-500027.509819312) + (31 / 2 * 130 * T)

# Interaction parameters -------------------------------------------------------------------
def LTI_MN_HV_0(T):
    return -89338.12435638 
def LTI_MN_HV_1(T):
    return  -178271.88502706  
def LTI_MN_HV_2(T):
    return -25701.82349495

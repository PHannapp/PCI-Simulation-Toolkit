...
# Endmembers -------------------------------------------------------------------------------
def GTI_MN_V(T):
   return 8*GHSERTI(T) + 16*GHSERMN(T) + 0*GHSERH2(T) + (-559868.4554059178) + (0* T)
def GTI_MN_H(T):
   return 8*GHSERTI(T) + 16*GHSERMN(T) + 31/2*GHSERH2(T) + (-500027.34683207364) + (31 / 2 * 130 * T)

# Interaction parameters -------------------------------------------------------------------
def LTI_MN_HV_0(T):
    return -101470.19741953  

def LTI_MN_HV_1(T):
    return  -48509.91278865  
def LTI_MN_HV_2(T):
    return 103508.62949302

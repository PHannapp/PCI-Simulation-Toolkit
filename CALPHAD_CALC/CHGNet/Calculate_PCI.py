...
def gm_gas(T, p):
    return (
        database_gas.GHSERH2(T)
        + T * R_CONST * np.log(0.0000098692327 * p)
        - 4.29e-06 * database_gas.FF1(p)
        - 6.35e-06 * database_gas.FF2(p)
        - 4.25e-06 * database_gas.FF3(p)
        + 1.5e-06 * database_gas.FF4(p)
        + 1.63e-06 * database_gas.FF5(p)
        + 2.479e-06 * p
        + 198428
    ) / 2

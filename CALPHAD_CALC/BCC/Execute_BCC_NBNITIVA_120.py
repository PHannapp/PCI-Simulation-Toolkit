...
exp= [
[
[0.8735294117647061, 0.0001063935043780138],
[0.9176470588235297, 0.010588750627766503],
[1.032352941176471, 0.406158598837698],
[1.1029411764705885, 0.6388266462055302],
[1.16764705882353, 0.8303375119605354],
[1.4176470588235297, 1.4028070170045566],
[1.5264705882352947, 2.1036881784318844],
[1.620588235294118, 3.639792322183328],
[1.6823529411764708, 10.63935043780139],
[1.7352941176470593, 30.366983698207587],
[1.7411764705882358, 100.0000000000001],
[1.7235294117647064, 4.199411234979421],
[1.644117647058824, 0.3051209653167377],
[1.505882352941177, 0.06327646895319197],
[1.3676470588235299, 0.041200912271559684],
[1.2147058823529415, 0.026195063869749347],
[1.0205882352941178, 0.01626223094126633],
[0.9294117647058826, 0.008343053946548225],
[0.908823529411765, 0.002786984642508531],
[0.882352941176471, 0.0001063935043780138],
]
]
for expe in exp:
...
exp_names = ["Nb33.7Ni2.2Ti31.7V32.4, Experiment"]
for num in range(len(file_names_BCC)):
    ...
    solids =[[["NB", "NI", "TI", "VA"]], [["NB", "NI", "TI", "VA"]]]  # Define solids involved in the structure
    multiplicities = [multiplicitiess_BCC[num], multiplicitiess_FCC[num]]  # Define the multiplicity of sites in the structure
    x_NB = 0.337
    x_NI = 0.022
    x_TI = 0.317  
    site_fractions = [[[x_NB, x_NI, x_TI, 1-x_NB-x_NI-x_TI]], [[x_NB, x_NI, x_TI, 1-x_NB-x_NI-x_TI]]]  # Initial site fractions for hydrogen
    color = ["blue"]
    FORCE = True
    MIN_Y = -3
    MAX_Y = 7
    ...
    T = 273.15+120  # Set temperature (in Kelvin)
    t0 = time.time()
    for i in range(1):
        structure_list = []

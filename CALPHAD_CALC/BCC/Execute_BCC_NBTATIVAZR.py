...
for num in range(len(file_names_BCC)):
    ...
    solids =[[["NB", "TA", "TI", "VA", "ZR"]], [["NB", "TA", "TI", "VA", "ZR"]]]  # Define solids involved in the structure
    multiplicities = [multiplicitiess_BCC[num], multiplicitiess_FCC[num]]  # Define the multiplicity of sites in the structure
    x_NB = 0.15
    x_TA = 0
    x_TI = 0.25  
    x_VA = 0.15 
    site_fractions = [[[x_NB, x_TA, x_TI, x_VA, 1-x_NB-x_TA-x_TI-x_VA]], [[x_NB, x_TA, x_TI, x_VA, 1-x_NB-x_TA-x_TI-x_VA]]]  # Initial site fractions for hydrogen
    color = ["blue"]
    FORCE = True
    MIN_Y = -10
    MAX_Y = 10

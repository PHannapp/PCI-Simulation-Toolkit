...
dir = r"/home/pet69516/Dokumente/DFTforCALPHAD_home/CALPHAD_CALC/BCC/"

# Choose a colormap
cmap = plt.cm.get_cmap('Set1', 10)
file_names_BCC = [
#"database_BCC_10_nothing",
"database_BCC_or_unified",
...
for num in range(len(file_names_BCC)):
    ...
    solids =[[["VA"]], [["VA"]]]  # Define solids involved in the structure
    multiplicities = [multiplicitiess_BCC[num], multiplicitiess_FCC[num]]  # Define the multiplicity of sites in the structure
    x_NB = 1
    site_fractions = [[[x_NB]], [[x_NB]]]  # Initial site fractions for hydrogen
    color = ["blue"]
    FORCE = True
    MIN_Y =2
    MAX_Y = 12
    ...
    T = 298  # Set temperature (in Kelvin)
    t0 = time.time()
    for i in range(1):
        structure_list = []
